  ...
  <body>
    <div class="span8 offset1">
      ...
      <table class="table table-hover">
        <tr><th>#</th><th>标题</th><th>浏览次数</th><th>操作</th></tr>
        <?php if(is_array($type_rs)): $i = 0; $__LIST__ = $type_rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($type["post_id"]); ?></td><td><?php echo (mb_substr($type["title"],0,12,'utf8')); ?></td><td><?php echo ($type["view"]); ?></td><td><a href="__URL__/edit/post_id/<?php echo ($type["post_id"]); ?>"> 编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="__URL__/delete/post_id/<?php echo ($type["post_id"]); ?>">删除</a></td></tr/><?php endforeach; endif; else: echo "" ;endif; ?>
      </table>
